...
class _HomePageState extends State<HomePage> {
  ...
  Widget _getContentWidget() {
    return  StreamBuilder<HomeStreamController>(
      stream: _viewModel.outputHomeStreamController,
      builder: (context, snapshot) {
        return Column(
          ...
          child: ListView(
            ...
            children: services.map((service) => Card(
              ...
              children: [
                ...
                Padding(padding: EdgeInsets.only(top: AppPadding.p8),
                child: Align(
